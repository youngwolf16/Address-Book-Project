...
{
    /*int numDummyContacts = sizeof(dummyContacts) / sizeof(dummyContacts[0]);  //number of elements in the array
    ...
    int size = sizeof(dummyContacts)/sizeof(dummyContacts[0]);  //find the size of dummmy contact
    //copying the dummy contact to addressbook contacts 
